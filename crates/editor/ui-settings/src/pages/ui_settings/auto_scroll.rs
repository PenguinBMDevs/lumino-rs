        ...
        column![
            ...
            row![
                ...
                text_input(t.pixel, &settings.auto_scroll.fixed_position.to_string())
                    .on_input(|v| {
                        Message::Settings(crate::Event::AutoScrollFixedPositionChanged(v))
                    })
                    .width(80.0),
            ...
            row![
                ...
                .on_input(|v| {
                    Message::Settings(crate::Event::AutoScrollPageTriggerOffsetChanged(v))
                })
                .width(80.0),
                iced_widget::space().width(SPACING_ICON_LABEL),
                text(t.from_right)
            ...
            row![
                ...
                .on_input(|v| {
                    Message::Settings(crate::Event::AutoScrollPageReturnPositionChanged(v))
                })
                .width(80.0),
                iced_widget::space().width(SPACING_ICON_LABEL),
                text(t.from_left)
