...
pub struct MainTranslations {
    ...
    pub right_sidebar_show: &'static str,
    pub right_sidebar_hide: &'static str,
    ...
    // ── 事件浏览器 ──
    pub eb_archive: &'static str,
    pub eb_hash: &'static str,
    pub eb_tick: &'static str,
    pub eb_position: &'static str,
    pub eb_value: &'static str,
    pub eb_shape: &'static str,
    pub eb_id: &'static str,
    pub eb_gate: &'static str,
    pub eb_end_tick: &'static str,
    pub eb_end_pos: &'static str,
    pub eb_key: &'static str,
    pub eb_velocity: &'static str,
    pub eb_channel: &'static str,
    pub eb_key_colon: &'static str,
    pub eb_value_colon: &'static str,
    pub eb_step: &'static str,
    pub eb_curve: &'static str,
    pub eb_major: &'static str,
    pub eb_minor: &'static str,
    pub eb_dorian: &'static str,
    pub eb_phrygian: &'static str,
    pub eb_lydian: &'static str,
    pub eb_mixolydian: &'static str,
    pub eb_aeolian: &'static str,
    pub eb_locrian: &'static str,
    pub eb_harmonic_minor: &'static str,
    pub eb_melodic_minor: &'static str,
    pub eb_insert_above: &'static str,
    pub eb_insert_below: &'static str,
    pub eb_delete: &'static str,
    pub eb_loaded: &'static str,
    pub eb_numerator: &'static str,
    pub eb_denominator: &'static str,
    pub eb_root: &'static str,
    pub eb_scale: &'static str,
    pub eb_program: &'static str,

    // ── 事件浏览器树项名称 ──
    pub eb_conductor: &'static str,
    pub eb_tempo: &'static str,
    pub eb_time_sig: &'static str,
    pub eb_key_sig: &'static str,
    pub eb_markers: &'static str,
    pub eb_lyrics: &'static str,
    pub eb_chord: &'static str,
    pub eb_notes: &'static str,
    pub eb_program_change: &'static str,
    pub eb_project: &'static str,
    pub eb_format: &'static str,
    pub eb_version: &'static str,
    pub eb_author: &'static str,
    pub eb_bpm: &'static str,
    pub eb_division: &'static str,
    pub eb_track_count: &'static str,
    pub eb_note_count: &'static str,
    pub eb_created: &'static str,
    pub eb_modified: &'static str,
    pub eb_name: &'static str,
}
...
pub(crate) static ZHCN_MAIN: MainTranslations = MainTranslations {
    ...
    right_sidebar_show: "展开右侧面板",
    right_sidebar_hide: "收起右侧面板",
    ...
    eb_aeolian: "爱奥利亚",
    eb_locrian: "洛克里亚",
    eb_harmonic_minor: "和声小调",
    eb_melodic_minor: "旋律小调",
    eb_insert_above: "在上方插入",
    eb_insert_below: "在下方插入",
    eb_delete: "删除",
    eb_loaded: "已加载",
    eb_numerator: "分子",
    eb_denominator: "分母",
...
pub(crate) static ENUS_MAIN: MainTranslations = MainTranslations {
    ...
    right_sidebar_show: "Expand Right Panel",
    right_sidebar_hide: "Collapse Right Panel",
    ...
    eb_id: "id",
    eb_gate: "gate",
    eb_end_tick: "end_tick",
    eb_end_pos: "end_pos",
    eb_key: "key",
    eb_velocity: "velocity",
    eb_channel: "channel",
    eb_key_colon: "Key",
    eb_value_colon: "Value",
    eb_step: "Step",
    eb_curve: "Curve",
    eb_major: "Major",
    eb_minor: "Minor",
    eb_dorian: "Dorian",
    eb_phrygian: "Phrygian",
    eb_lydian: "Lydian",
    eb_mixolydian: "Mixolydian",
    eb_aeolian: "Aeolian",
    eb_locrian: "Locrian",
    eb_harmonic_minor: "Harmonic Minor",
    eb_melodic_minor: "Melodic Minor",
    eb_insert_above: "Insert Above",
    eb_insert_below: "Insert Below",
    eb_delete: "Delete",
    eb_loaded: "loaded",
    eb_numerator: "numerator",
    eb_denominator: "denominator",
    eb_root: "root",
    eb_scale: "scale",
    eb_program: "program",

    // Event browser tree item names
    eb_conductor: "Conductor",
    eb_tempo: "Tempo",
    eb_time_sig: "TimeSig",
    eb_key_sig: "KeySig",
    eb_markers: "Markers",
    ...
    eb_chord: "Chord",
    eb_notes: "Notes",
    eb_program_change: "Program Change",
    eb_project: "Project",
    eb_format: "Format",
    eb_version: "Version",
    eb_author: "Author",
    eb_bpm: "BPM",
    eb_division: "Division",
    eb_track_count: "Tracks",
    eb_note_count: "Notes",
    eb_created: "Created",
    eb_modified: "Modified",
    eb_name: "Name",
};
