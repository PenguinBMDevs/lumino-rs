...
pub struct SettingsTranslations {
    ...
    pub track_display_mode: &'static str,
    pub track_display_mode_label: &'static str,
    pub track_display_mode_hint: &'static str,
...
static ZHCN_SETTINGS: SettingsTranslations = SettingsTranslations {
    ...
    track_display_mode: "音轨列表显示模式",
    track_display_mode_label: "显示模式:",
    track_display_mode_hint: "按通道分组：音轨按 MIDI 通道分组排列，标签为 A01, A02, B01...；按音轨序号：保留原始排列，标签为 01, 02, 03...",
    pixel: "像素",
    from_left: "像素 (从左边缘算起)",
...
static ENUS_SETTINGS: SettingsTranslations = SettingsTranslations {
    ...
    track_display_mode: "Track List Display Mode",
    track_display_mode_label: "Display mode:",
    track_display_mode_hint: "Channel Grouped: tracks sorted by MIDI channel, labels as A01, A02, B01...; Track Index: keep original order, labels as 01, 02, 03...",
    pixel: "px",
