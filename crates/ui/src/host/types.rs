...
pub enum DialogResult {
    ...
    AudioExport {
        ...
        output_path: String,
        sample_rate: u32,
        channels: crate::state::root_state::AudioChannels,
        layers: u32,
        channel_threading: crate::state::root_state::ThreadingOption,
        key_threading: crate::state::root_state::ThreadingOption,
        apply_limiter: bool,
