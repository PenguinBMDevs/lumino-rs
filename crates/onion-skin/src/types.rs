...
mod tests {
    ...
    fn from_ms_sets_tick_to_zero() {
        ...
        let note = OnionSkinNote::from_ms(100.0, 200.0, 60, color);
    ...
    fn from_note_converts_tick_to_float() {
        ...
        let skin = OnionSkinNote::from_note(&note, color);
    ...
    fn from_note_info_copies_tick_fields() {
        ...
        let skin = OnionSkinNote::from_note_info(&info, color);
    ...
    fn from_note_event_copies_tick_fields() {
        ...
        let skin = OnionSkinNote::from_note_event(&event, color);
    ...
    fn from_ms_and_from_note_produce_compatible_tick_and_ms() {
        ...
        let skin = OnionSkinNote::from_note(&note, [0, 0, 0, 255]);
