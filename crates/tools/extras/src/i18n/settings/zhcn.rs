...
pub(super) static ZHCN_SETTINGS: SettingsTranslations = SettingsTranslations {
    ...
    font_hint: "系统字体与自定义字体文件二选一（文件路径优先）。字体加载失败时回退默认字体；切换后需重启程序生效。",
    font_restart_hint: "字体修改将在重启程序后生效",
    ...
    note_count_display: "音符总量显示位置",
    note_count_display_hint: "选择音符总量的展示位置：工程设置对话框中，或下边栏（空闲时顶替「就绪」；悬停解释与状态消息优先显示）。",
    note_count_display_project_settings: "工程设置面板",
    note_count_display_statusbar: "下边栏",
    pixel: "像素",
    from_left: "像素 (从左边缘算起)",
