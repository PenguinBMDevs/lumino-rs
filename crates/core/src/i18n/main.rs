...
static ZHCN_MAIN: MainTranslations = MainTranslations {
    skip_backward: "快退",
    pause: "暂停",
    play: "播放",
    skip_forward: "快进",
...
static ENUS_MAIN: MainTranslations = MainTranslations {
    ...
    status_ready: "Ready",
    sidebar_file: "File Manager",
    sidebar_arrangement: "Track Overview",
    sidebar_audio: "Audio Settings",
